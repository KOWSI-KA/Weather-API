...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=64457ed6974536ddd6af933d6d4faf8f'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyC_KZ4Mr5fY8LwysK29amsG3gfpfpqknAI'

    SEARCH_ENGINE_ID = 'a417d33f712544db8'
